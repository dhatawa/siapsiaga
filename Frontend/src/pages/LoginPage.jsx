...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex bg-gray-100">
      ...
      <div className="hidden md:flex md:w-1/2 bg-gradient-to-br from-indigo-200 via-blue-200 to-blue-300 relative items-end p-10 overflow-hidden">
        ...
        <form onSubmit={handleSubmit} className="w-full max-w-sm">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full border border-gray-200 rounded-lg pl-9 pr-3 py-2.5 text-sm outline-none focus:ring-2 focus:ring-primary-700/30 focus:border-primary-700"
            />
          </div>
          ...
          <div className="relative">
            ...
            <input
              ...
              placeholder="••••••••"
              className="w-full border border-gray-200 rounded-lg pl-9 pr-9 py-2.5 text-sm outline-none focus:ring-2 focus:ring-primary-700/30 focus:border-primary-700"
            />
            <button
              type="button"
